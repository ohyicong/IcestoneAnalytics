...
public class FeedosMySubscribeInstrumentsReceiverL1 implements
        ...
        Receiver_Quotation_ChgSubscribeInstrumentsL1 //![snippet_subL1]
{
    ...
    public void quotNotifTradeEventExt(
        ...
        iqd.update_with_TradeEventExt(
                server_timestamp, market_timestamp, trade_event
        );
        ...
        if (trade_event.content_mask.isSetClose()) {
            if (trade_event.content_mask.isSetOCHLdaily()) {
                ...
                flag_builder.append("<end session> ");
            }
        ...
        if (m_dump_cache&&MyUser.isNewDay) {
            //Edit here for level one information updates
            iqdArray[0] = iqd;
    ...
    public void quotChgSubscribeInstrumentsRemoveInstrumentsL1Response(
        ...
        System.out.println("Stock removed: " + rc);

    }

    @Override
    public void quotNotifTradeCancelCorrection(int i, Object o, int i1, long l, QuotationTradeCancelCorrection qtcc) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public void quotChgSubscribeInstrumentsAddInstrumentsL1Response(Object o, int i, InstrumentQuotationData[] iqds) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public void quotChgSubscribeInstrumentsNewContentMaskL1Response(Object o, int i, InstrumentQuotationData[] iqds) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public void quotChgSubscribeInstrumentsAddOtherValuesToLookForL1Response(Object o, int i, InstrumentQuotationData[] iqds) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
